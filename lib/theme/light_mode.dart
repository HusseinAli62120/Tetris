...
final Color _primary = Color(0xfffafafa);
final Color _onPrimary = Colors.purple;

final Color _secondary = Colors.purple;
final Color _onSecondary = Colors.grey.shade800;
...
// SnackBar
final Color _snackBarBackgroundColor = Colors.grey.shade100;
final Color _snackBarContentColor = Colors.grey.shade800;
